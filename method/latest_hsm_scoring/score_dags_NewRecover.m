function [score, cache, total_overwrite] = score_dags_NewRecover(data, ns, dags, varargin)
[n, ncases] = size(data);
type = cell(1, n);
params = cell(1, n);
for i = 1:n
...
for g = 1:NG
    ...
    for j = 1:n
        ps = parents(dags{g}, j);
        [scor, cache, ~, overwrite_count] = score_family_recover(j, ps, type{j}, ns, discrete, data, params{j}, cache, max_cache_size);
