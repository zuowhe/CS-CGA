# -*- coding: utf-8 -*-
"""Plot F1 curves for adaptive threshold embedding in MIGA."""
...
DATA_FILE = SCRIPT_DIR / "data" / "adaptive_threshold_miga.csv"
OUTPUT_DIR = SCRIPT_DIR / "output" / "adaptive_threshold_miga"
...
def plot_dataset(dataset, adaptive_value, fixed_points, output_dir, fonts):
    ...
    output_path = output_dir / f"{dataset}_MIGA_F1.pdf"
